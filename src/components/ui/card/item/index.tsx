    ...
    return(
        <div
            onClick={()=>router.push(url)}
             className={["hover:cursor-pointer border flex w-full h-72  md:h-96 rounded-md overflow-hidden flex flex-col justify-between hover:scale-105 transition-all",className].join(" ")}
             style={{
